...
function DialogOverlay({
  ...
  instant = false,
  ...props
}: React.ComponentProps<typeof DialogPrimitive.Overlay> & { instant?: boolean }) {
  return (
    ...
    <DialogPortal>
      ...
      <DialogPrimitive.Content
        ...
        className={cn(
          ...
          size === "editor" &&
            "h-[min(80vh,48rem)] w-[min(90vw,72rem)] !max-w-none grid-rows-[auto_minmax(0,1fr)_auto] overflow-hidden",
          className,
        )}
        {...props}
      >
