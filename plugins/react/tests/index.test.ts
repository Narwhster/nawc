...
import { react, reactPreviewHtml, reactSkill, resolveReactComponent } from "../src/index.ts";
...
describe("React plugin", () => {
  ...
  it("documents React plugin configuration and component authoring", () => {
    ...
    expect(reactSkill).toContain('<react-interactive file="path/to/component.tsx" />');
